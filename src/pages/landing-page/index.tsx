...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#fffbf7]">
      ...
      {/* Hero Section */}
      <section className="container mx-auto px-4 pb-4 md:pb-4 pt-12 md:pt-20">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-[#111827] mt-5 mb-2">
        Connecting Hearts,
        <br />
        <span className="text-[#f97343]">Transforming Lives</span>
          </h1>
          <p className="text-[#3f4550] mb-4 max-w-2xl mx-auto">
      ...
      {/* Our Approach */}
      <section id="our-offerings" className="container mx-auto  py-12 md:py-20">
