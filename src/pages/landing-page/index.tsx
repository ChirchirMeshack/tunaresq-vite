  ...
  return (
    <>
      ...
      <section id="our-offerings" className="container mx-auto px-4 pt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:max-w-5xl mx-auto">
          {[
        {
      ...
      <section id="about" className="container mx-auto px-4 py-12 md:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:max-w-4xl mx-auto">
          {[
        {
      ...
      <section id="how-it-works" className="py-2 md:pt-4">
        ...
        How TunaresQ Works
          ...
          {/* Step 1 */}
          <div className="md:w-3/4 md:mx-auto px-2 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-2 lg:gap-24 mb-12 items-center">
        ...
        <div className="">
          ...
          {/* Step 2 */}
          <div className="md:w-3/4 md:mx-auto px-2 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-2 lg:gap-4 mb-12 items-center">
        ...
        <div className="md:pr-32 flex flex-col space-y-4">
          ...
          {/* Step 3 */}
          <div className="md:w-3/4 md:mx-auto px-2 md:px-0 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-2 mb-12 items-center">
        ...
        <div className="relative rounded-lg overflow-hidden mx-auto">
          ...
          {/* Step 4 */}
          <div className="md:w-3/4 md:mx-auto px-2 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-4 items-center">
        <div className="relative rounded-lg overflow-hidden order-last md:order-first mx-auto">
          <img
