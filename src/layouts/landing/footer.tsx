...
const LandingFooter = () => {
  return (
    // {/* Previous: footer className="bg-[#111827] text-white pt-12 pb-0" with padding styles */}
    <footer 
      className="bg-[#111827] text-white pt-12 pb-0"
      style={{ 
        boxSizing: 'border-box',
        margin: '0',
        padding: '3rem 0 0 0', // No right padding
        width: '100%' // Ensure full width
      }}
    >
      {/* Previous: max-w-7xl mx-auto px-4 with padding styles */}
      <div 
        className="w-full"
        style={{ 
          boxSizing: 'border-box',
          margin: '0',
          paddingLeft: '1rem',
          paddingRight: '0', // Remove right padding completely
          width: '100%'
        }}
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          {/* Right: Group img - TOUCHING RIGHT MARGIN */}
          {/* Previous: flex justify-end mt-8 md:mt-0 md:ml-8 md:flex-shrink-0 */}
          <div 
            className="flex justify-end mt-8 md:mt-0 md:ml-8 md:flex-shrink-0"
            style={{ 
              boxSizing: 'border-box',
              marginRight: '0', // Touch right edge
          ...
          >
            <img
              ...
              style={{
                marginRight: '0', // SVG touches right edge
                paddingRight: '0'
              }}
            />
          </div>
