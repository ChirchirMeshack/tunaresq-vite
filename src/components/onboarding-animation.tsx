...
export default function FundraiserLaunchProgress({
  ...
  const {fundraiserDetails} =useFundraiserTypeStore()
      ...
      <Card className="w-full max-w-2xl ">
        <CardContent className="p-12 text-center space-y-8">
          ...
          <button onClick={()=>{completeCurrentStep()
            navigate(PATHS.fundraiser.view('1'))}
          } className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md">Complete Step</button>
        </CardContent>
      </Card>
    </div>
  )
